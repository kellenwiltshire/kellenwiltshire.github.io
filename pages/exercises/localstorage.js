...
function localstorage() {
	...
	return (
		<Layout>
			...
			<div className='localstoragebackground flex-row flex-wrap'>
				<div className='flex flex-row flex-wrap justify-center space-y-2'>
					<svg
						className='localstoragesvg'
					...
					<div className='wrapper w-full'>
						<h2 className='text-2xl text-center'>LOCAL TAPAS</h2>
						<p></p>
						<ul className='plates'>
							<li>Loading Tapas...</li>
						</ul>
						...
						<button
							onClick={deleteItems}
							className='p-3 outline-none border border-gray-300 mt-2'
						>
							Delete All
						</button>
					</div>
