import GolfleagueReadMe from '../../Markdowns/golfleague.md';
...
function golfleague({ isDarkMode, setIsDarkMode }) {
	...
	return (
		<div className='mx-auto min-h-screen max-w-7xl bg-white dark:bg-gray-700'>
			<NextSeo
				title={`Kellen Wiltshire | Golf League Tracker`}
				description='Golf League Tracker app for Scores and Attendance'
			/>
