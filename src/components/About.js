		...
		>
			...
			<div className='text-black text-center w-full text-xs sm:text-base xl:w-6/12 space-y-3'>
				<p>
					...
					University of Ontario Institute of Technology in 2012. Although
					initially enrolled in Game Development he switch to Legal Studies.
				</p>

				<p>
					Although he was able to find a fulfilling career helping people seek
					justice in the Legal System, he missed using his brain in a technical
					role. With the extra time working from home he decided to start
					teaching himself Web Development with the help of the Udemy course
					Zero-to-Mastery.
				</p>

				<p>
					Now he builds websites and projects to hone his skills to make the
					jump completely into Web Development. Contact him now if you have any
					inquries!
				</p>
			</div>
		</div>
