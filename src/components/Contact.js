...
const contact = () => {
    return(
        <div className="flex flex-col items-center mb-10">
            <h1 className="text-3xl tracking-widest">Interested?</h1>
                            ...
                            <div class="shadow overflow-hidden sm:rounded-md">
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <label for="product" class="block text-sm font-medium text-gray-700">Inquiring About</label>
                                            <select id="product" name="product" autocomplete="product" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
