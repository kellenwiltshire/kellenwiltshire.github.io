...
const splash = () => {
    return (
        <div className="splash h-screen flex flex-col items-center justify-center">
            ...
            <div className="flex flex-row bg-black bg-opacity-50 rounded mt-16 text-white py-4 px-10">
                <a href="https://github.com/kellenwiltshire" alt="View on Github" target="_blank">
                    <svg className="px-2" xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-github" width="64" height="64" viewBox="0 0 24 24" stroke-width="0.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
