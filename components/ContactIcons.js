		...
		<div className='flex flex-row align-middle justify-center'>
			<div className='flex flex-col align-middle justify-center'>
				...
				>
					<svg
						...
						className='icon icon-tabler icon-tabler-brand-github rounded transition duration-300 ease-in-out hover:bg-blue-900 p-4'
						width='100'
						height='100'
						viewBox='0 0 24 24'
						strokeWidth='1.5'
			...
			<div className='flex flex-col align-middle justify-center text-center'>
				...
				>
					<svg
						xmlns='http://www.w3.org/2000/svg'
						className='icon icon-tabler icon-tabler-brand-codepen rounded transition duration-300 ease-in-out hover:bg-blue-900 p-4'
						width='100'
						height='100'
						viewBox='0 0 24 24'
						strokeWidth='1.5'
