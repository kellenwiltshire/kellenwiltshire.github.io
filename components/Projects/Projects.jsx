...
export default function Projects({
	...
	return (
		<div className='mx-auto min-h-screen max-w-7xl bg-white dark:bg-gray-700'>
			<NextSeo title={`Kellen Wiltshire | ${projectTitle}`} description={projectDescription} />
					...
					<div className='mt-8 rounded-md bg-gray-50 py-2 pb-12 dark:bg-gray-700 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-12'>
						<div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
							<div className='grid-cols-1 space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0'>
								<a href={link} className='aspect-w-3 aspect-h-2 sm:aspect-w-5 sm:aspect-h-3'>
									<img className='object-fit relative rounded-lg shadow-lg' src={image} alt='' />
								</a>
